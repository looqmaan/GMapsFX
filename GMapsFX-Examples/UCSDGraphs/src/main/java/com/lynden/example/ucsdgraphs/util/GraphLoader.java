 ...
 * graph structures.
 */
package com.lynden.example.ucsdgraphs.util;

import com.lynden.example.ucsdgraphs.basicgraph.Graph;
import com.lynden.example.ucsdgraphs.geography.GeographicPoint;
import com.lynden.example.ucsdgraphs.geography.RoadSegment;
import com.lynden.example.ucsdgraphs.roadgraph.MapGraph;
        ...
        try {
            ...
            reader = new BufferedReader(
                new InputStreamReader(
                    GraphLoader.class.getResourceAsStream(classPathPrefix + filename)
                )
            );
