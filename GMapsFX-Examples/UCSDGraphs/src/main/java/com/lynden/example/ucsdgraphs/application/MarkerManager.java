...
public class MarkerManager {
    ...
    public MarkerManager() {
        markerMap = new HashMap<GeographicPoint, Marker>();
        this.map = null;
    ...
    public void putMarker(GeographicPoint key, Marker value) {
...
//        startMarker.setZIndex(STRTDEST_Z);
    ...
    public void setDestination(GeographicPoint point) {
        if (destinationMarker != null) {
            ...
            immediateMarkerOptions.icon(markerURL);
            destinationMarker.setOptions(immediateMarkerOptions);
...
//        destinationMarker.setZIndex(STRTDEST_Z);
    ...
    public void changeIcon(Marker marker, String url) {
        ...
        // TODO: Need to test
        MarkerOptions immediateMarkerOptions = new MarkerOptions();
        immediateMarkerOptions.icon(url);
        marker.setOptions(immediateMarkerOptions);
    ...
    public void restoreMarkers() {
        Iterator<GeographicPoint> it = markerMap.keySet().iterator();
        while (it.hasNext()) {
...
//        	map.addMarker(marker);
    ...
    public void displayMarker(GeographicPoint point) {
    ...
    public void displayDataSet() {
        markerPositions = new ArrayList<GeographicPoint>();
        dataSet.initializeGraph();
        Iterator<GeographicPoint> it = dataSet.getIntersections().iterator();
...
//            marker.setZIndex(DEFAULT_Z);
    ...
    private void registerEvents(Marker marker, GeographicPoint point) {
        ...
        map.addUIEventHandler(marker, UIEventType.click, (JSObject o) -> {
            ...
            if (selectMode) {
                if (selectedMarker != null && selectedMarker != startMarker
                    ...
                    MarkerOptions immediateMarkerOptions = new MarkerOptions();
                    immediateMarkerOptions.icon(markerURL);
                    selectedMarker.setOptions(immediateMarkerOptions);
...
//                		selectedMarker.setZIndex(DEFAULT_Z);
                ...
                // TODO: Need to test
                MarkerOptions immediateMarkerOptions = new MarkerOptions();
                immediateMarkerOptions.icon(SELECTED_URL);
                selectedMarker.setOptions(immediateMarkerOptions);
