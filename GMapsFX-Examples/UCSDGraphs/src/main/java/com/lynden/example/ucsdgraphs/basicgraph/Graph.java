 ...
 */
package com.lynden.example.ucsdgraphs.basicgraph;
...
public abstract class Graph {
    ...
    /**
     * Abstract method implementing adding a new vertex to the representation of the
     * graph.
     */
    ...
    /**
     * Abstract method implementing adding a new edge to the representation of the
     * graph.
     */
     ...
     * @return List of indices of all vertices that are adjacent to v via outgoing
     *         edges from v.
     */
     ...
     * @param v
     *            Index of vertex in question.
     * @return List of indices of all vertices that are adjacent to v via incoming
     *         edges to v.
     */
    public abstract List<Integer> getInNeighbors(int v);

    /**
     * The degree sequence of a graph is a sorted (organized in numerical order from
     * largest to smallest, possibly with repetitions) list of the degrees of the
     ...
     *         following two edges) from vertex v. XXX: Implement in part 2 of week
     *         2 for each subclass of Graph
     */
    ...
    /**
     * Create a new map of vertex indices to string labels (Optional: only if using
     * labeled vertices.)
     */
    ...
    public static void main(String[] args) {
        // GraphLoader.createIntersectionsFile("data/maps/ucsd.map",
        // "data/intersections/ucsd.intersections");
        // GraphLoader.createIntersectionsFile("data/maps/TestMap.map",
        // "data/intersections/TestMap.intersections");
