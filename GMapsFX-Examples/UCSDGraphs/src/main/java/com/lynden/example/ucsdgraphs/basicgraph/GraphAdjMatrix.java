...
public class GraphAdjMatrix extends Graph {
    ...
    /**
     * Implement the abstract method for adding an edge. Allows for multiple edges
     * between two points: the entry at row v, column w stores the number of such
     * edges.
     *
     * @param v
    ...
    /**
     * Implement the abstract method for finding all out-neighbors of a vertex. If
     * there are multiple edges between the vertex and one of its out-neighbors,
     * this neighbor appears once in the list for each of these edges.
     *
     * @param v
     *            the index of vertex.
    ...
    /**
     * Implement the abstract method for finding all in-neighbors of a vertex. If
     * there are multiple edges from another vertex to this one, the neighbor
    ...
    /**
     * Implement the abstract method for finding all vertices reachable by two hops
     * from v. Use matrix multiplication to record length 2 paths.
     *
     * @param v
     *            the index of vertex.
     * @return List<Integer> a list of indices of vertices.
    ...
    public List<Integer> getDistance2(int v) {
        ...
        List<Integer> neighborsOfNeighbors = new ArrayList<>();

        neighbors.forEach(n -> {
            neighborsOfNeighbors.addAll(getNeighbors(n));
        });
